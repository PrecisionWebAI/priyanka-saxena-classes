...
const Home = (props: Props) => {
  const imgUrl1 =
    "https://priyankasaxenaclasses.com/wp-content/uploads/2024/01/Design.png";

  return (
    <div>
      <div className="flex items-center" style={{ backgroundColor: "red" }}>
        <div
          className="sign"
          style={{
            fontSize: "25px",
      ...
      <div
        className="Content h-96 w-screen flex flex-col md:flex-row sm:flex-row"
        style={{ height: "600px" }}
      >
        <div
          className="left-side"
        ...
        >
          <div className="child-box">
            <img
              ...
              style={{ height: "100px", width: "300px", marginLeft: "15px" }}
            />
          </div>
          <div
            className="first"
